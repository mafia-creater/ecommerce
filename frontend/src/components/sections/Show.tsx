...
type CollectionKey = "BEST SELLERS" | "SAKURA";

const collections: Record<CollectionKey, { name: string; price: number; front: string; back: string; }[]> = {
  "BEST SELLERS": [
    { name: "Product 1", price: 50, front: '/images/FANGS1.webp', back: '/images/FANGS2.webp' },
...
export default function ShopPage() {
  const [activeCollection, setActiveCollection] = React.useState<CollectionKey>("BEST SELLERS");
    ...
    <div className="p-6">
      ...
      <div className="flex gap-8 justify-center mb-10 font-[F.] text-2xl uppercase tracking-wide text-gray-500">
        {Object.keys(collections).map((collection) => (
          <button
            key={collection}
            onClick={() => setActiveCollection(collection as CollectionKey)}
